+------------+--------------------------------------------+--------------------------------------------------------------------------------+-------------------------------+------------+
| **Length** | ``Metadata.CommitMessage.Shortlog.Length`` | `Parent <Metadatacoala/aspect-docs/CommitMessagecoala/aspect-docs/Shortlog>`_  | `Index </coala/aspect-docs>`_ | `Top <#>`_ |
+------------+--------------------------------------------+--------------------------------------------------------------------------------+-------------------------------+------------+
