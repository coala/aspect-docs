+--------------------+----------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------+------------+
| **TrailingPeriod** | ``Metadata.CommitMessage.Shortlog.TrailingPeriod`` | `Parent <github.com/coala/aspect-docs/Metadata/CommitMessage/Shortlog>`_  | `Index <github.com/coala/aspect-docs>`_ | `Top <#>`_ |
+--------------------+----------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------+------------+
