+-----------+-------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------+------------+
| **Tense** | ``Metadata.CommitMessage.Shortlog.Tense`` | `Parent <github.com/coala/aspect-docs/Metadata/CommitMessage/Shortlog>`_  | `Index <github.com/coala/aspect-docs>`_ | `Top <#>`_ |
+-----------+-------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------+------------+
